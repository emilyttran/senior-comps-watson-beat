...
class PianoSolo:
    ...
    def __init__(self, movement, selectedTempo):
        ...
        self.groupLayers = {
            'rhythm': {'layers': ['bass3', 'drumsKit', 'rightPiano', 'brassRhythms'], 'heavy': 4, 'lite': 2,
                       'medium': 3},
        ...
        self.layers = {
            ...
            'piano1': {'density': 1, 'range': 'mid', 'type': ''},
        ...
        self.MaxAndMinLayersForEnergy = {
            'high': {'max': 5, 'min': 4, 'initialMax': 4, 'initialMin': 3},
            'medium': {'max': 4, 'min': 3, 'initialMax': 4, 'initialMin': 3},
            'low': {'max': 3, 'min': 2, 'initialMax': 4, 'initialMin': 3},
        }
    ...
    def InitializeMoodForSimple(self, sections):
        ...
        if (0):
            for secId in self.sections:
                print("Id", secId, "startMNum: ", self.sections[secId]['startMNum'], "endMNum: ",
                      self.sections[secId]['endMNum'], 'Mel Id: ', self.sections[secId]['melId'])
