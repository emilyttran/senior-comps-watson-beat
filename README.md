I used the Watson Beat for my senior project. Below is the original README for Watson Beat. The original Github repo is [here](https://github.com/cognitive-catalyst/watson-beat)
